        ...
        title: (
          <TagDropDown
            handleChange={(newTags) => {
              instance.setState({ tags: newTags }, () =>
    ...
    if (this.state.title !== "") {
      MySwal.fire({
        ...
        .then(async () => {
          ...
          let tagArr = tags.map((tag) => tag.label);
          const postContentData = await editor.save();
          await firestore.collection("drafts").doc(draftId).delete();
          console.log({
            title: title || "",
            subtitle: subtitle || "",
            postContentData: postContentData || "",
        ...
        <div className="create-post-form">
          ...
          <div className="content-field">
            <EditorJS
              ...
              tools={editorJsTools}
              data={
                (editingPost && editingPost.postContentData) ||
                (draft && draft.data)
              }
            >
              <div id="editorjs" />
          ...
          {this.state.editMode ? (
            ...
            <button
              className="create-post-btn"
              onClick={() => {
                this.handleSubmitDraft(this, this.props.draft.id);
              }}
            >
              POST
            </button>
